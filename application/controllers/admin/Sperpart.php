...
class Sperpart extends Super
{
    ...
    function __construct()
    {
        ...
        $this->tabel          = "suku_cadang";
        $this->active_id_menu = "suku cadang";
        $this->nama_view      = "suku cadang";
        $this->status         = true; 
    ...
    function index(){
            ...
            **/
            $this->crud->set_relation('id_kategori','kategori','nama_kategory');
